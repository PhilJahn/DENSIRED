...
class SCAR:
    """
    Implementation of SCAR as proposed in the Bachelor Thesis
    'Acceleration Robust Spectral Clustering Using the Nyström Method'
    ...
    def __latent_decomposition(self, X):
        ...
        for it in range(self.n_iter):
            ...
            allowed_to_remove_per_node = (deg * self.m).astype(np.int32)
            prev_trace = trace
